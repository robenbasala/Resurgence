import {
  ...
  querystringDecode,
  registerVersion
} from "./chunk-WVD3PYQE.js";
import "./chunk-G3PMV62Z.js";

// node_modules/firebase/node_modules/@firebase/auth/dist/esm/index-907e9a1a.js
var FactorId = {
...
var MockReCaptcha = class {
  ...
  reset(optWidgetId) {
    ...
    void ((_a = this._widgets.get(id)) == null ? void 0 : _a.delete());
    this._widgets.delete(id);
  }
  getResponse(optWidgetId) {
    var _a;
    const id = optWidgetId || _WIDGET_ID_START;
    return ((_a = this._widgets.get(id)) == null ? void 0 : _a.getResponse()) || "";
  }
  async execute(optWidgetId) {
    var _a;
    const id = optWidgetId || _WIDGET_ID_START;
    void ((_a = this._widgets.get(id)) == null ? void 0 : _a.execute());
    return "";
  }
};
...
async function signInAnonymously(auth) {
  ...
  if ((_a = authInternal.currentUser) == null ? void 0 : _a.isAnonymous) {
...
function isSignInWithEmailLink(auth, emailLink) {
  const actionCodeUrl = ActionCodeURL.parseLink(emailLink);
  return (actionCodeUrl == null ? void 0 : actionCodeUrl.operation) === "EMAIL_SIGNIN";
}
...
function _fromIdTokenResponse(idTokenResponse) {
  ...
  if (!providerId && (idTokenResponse == null ? void 0 : idTokenResponse.idToken)) {
    const signInProvider = (_b = (_a = _parseToken(idTokenResponse.idToken)) == null ? void 0 : _a.firebase) == null ? void 0 : _b["sign_in_provider"];
    if (signInProvider) {
...
var GithubAdditionalUserInfo = class extends FederatedAdditionalUserInfoWithUsername {
  constructor(isNewUser, profile) {
    super(isNewUser, "github.com", profile, typeof (profile == null ? void 0 : profile.login) === "string" ? profile == null ? void 0 : profile.login : null);
  }
};
...
var MultiFactorSessionImpl = class _MultiFactorSessionImpl {
  ...
  static fromJSON(obj) {
    var _a, _b;
    if (obj == null ? void 0 : obj.multiFactorSession) {
      if ((_a = obj.multiFactorSession) == null ? void 0 : _a.pendingCredential) {
        return _MultiFactorSessionImpl._fromMfaPendingCredential(obj.multiFactorSession.pendingCredential);
      } else if ((_b = obj.multiFactorSession) == null ? void 0 : _b.idToken) {
...
function getMultiFactorResolver(auth, error) {
  ...
  _assert(
    (_a = errorInternal.customData._serverResponse) == null ? void 0 : _a.mfaPendingCredential,
    authModular,
    "argument-error"
    /* AuthErrorCode.ARGUMENT_ERROR */
  );
...
function getDocumentCookie(name2) {
  ...
  return ((_a = document.cookie.match(matcher)) == null ? void 0 : _a[1]) ?? null;
}
...
var ReCaptchaLoaderImpl = class {
  constructor() {
    ...
    this.hostLanguage = "";
    this.counter = 0;
    this.librarySeparatelyLoaded = !!((_a = _window().grecaptcha) == null ? void 0 : _a.render);
  }
  load(auth, hl = "") {
    _assert(
  ...
  shouldResolveImmediately(hl) {
    var _a;
    return !!((_a = _window().grecaptcha) == null ? void 0 : _a.render) && (hl === this.hostLanguage || this.counter > 0 || this.librarySeparatelyLoaded);
  }
};
